...
const index = () => {
  ...
  const { formik, localStates, courierApi, expediteurApi, typeApi, statusApi, attachmentsApi, classificationApi } = useCouriersStateHandler()
  const { search, setSearch } = localStates.searchState
